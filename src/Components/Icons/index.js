export const MessageIcon = ({ className, height = '2.8rem', width = '2.8rem' }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const AddIcon = ({ className, height = '2rem', width = '2rem' }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const SearchIcon = ({ className, height = '24', width = '24' }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const ClearIcon = ({ className, height = '16', width = '16' }) => {
    <svg
        className={className}
        width={width}
        height={height}
